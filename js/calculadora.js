...
const RAW_PROFILES = {
    ...
    elec:  [1.10, 1.55, 1.20, 0.95, 0.85, 0.90, 0.45, 0.12, 1.05, 1.10, 1.15, 0.75],
    water: [0.62, 0.64, 0.78, 0.93, 1.08, 1.28, 1.48, 1.42, 1.06, 0.88, 0.75, 0.55],
    paper: [0.85, 0.90, 0.95, 0.90, 1.00, 1.30, 0.20, 0.10, 1.40, 1.05, 0.95, 0.35],
    clean: [0.90, 0.90, 0.95, 0.95, 0.95, 1.20, 0.40, 0.25, 1.35, 1.05, 0.95, 0.60]
};
